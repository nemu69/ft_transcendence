...
export class School42Strategy extends PassportStrategy(Strategy, 'school42') {
	constructor(private usersService: UserService) {
		super({
			authorizationURL: "https://api.intra.42.fr/oauth/authorize?client_id=999c140195c8f4b412254d790158ed245e0fb3b59ca0fa9e916a46e144d4153b&redirect_uri=http%3A%2F%2F10.4.7.5%3A4200%2Fpublic%2Fcallback&response_type=code",
			tokenURL: "https://api.intra.42.fr/oauth/token",
			clientID: process.env.OAUTH_42_UID,
			clientSecret: process.env.OAUTH_42_SECRET,
			callbackURL: "http://10.4.7.5:4200/public/callback",
			scope: 'public',
			proxy: true
		});
	}
