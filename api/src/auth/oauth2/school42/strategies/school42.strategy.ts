...
export class School42Strategy extends PassportStrategy(Strategy, 'school42') {
	constructor(private usersService: UserService) {
		super({
			authorizationURL: "https://api.intra.42.fr/oauth/authorize?client_id=999c140195c8f4b412254d790158ed245e0fb3b59ca0fa9e916a46e144d4153b&redirect_uri=http%3A%2F%2Flocalhost%3A4200%2Fpublic%2Fcallback&response_type=code",
